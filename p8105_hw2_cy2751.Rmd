...
Also remove all OUT bakers from the further results for simplicity.(The last appearance of each baker is at the time it OUT).
Order matters, first combine which one does matters!
